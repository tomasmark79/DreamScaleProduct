...
- The illuminated keyboard photograph is the supplied `IMG20260318195511.jpg`, copied unchanged to `assets/dreamscaler-in-action.jpg` and featured below the opening headline and buttons. Both original photographs remain local and ignored by Git.
